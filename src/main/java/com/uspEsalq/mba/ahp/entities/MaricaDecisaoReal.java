...
@Entity
@Table(name = "tb_marica_decReal")
public class MaricaDecisaoReal  implements Serializable {
	...
	public MaricaDecisaoReal() {
		
	}

	public MaricaDecisaoReal(Long id, String acoes, Double valor, Double rentabilidade, Double risco,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MaricaDecisaoReal other = (MaricaDecisaoReal) obj;
